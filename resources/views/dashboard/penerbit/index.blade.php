    ...
    <div class="row pt-3 pb-2">
        <div class="col-md-12">
            ...
            <div class="card ">
                ...
                <div class="card-body">
                    <a href="{{ route('penerbit.create') }}" class="btn btn-md btn-success mb-3 float-right">Tambah</a>
                                    ...
                                    <td class="text-center">
                                        <div class="dropdown">
                                            ...
                                            <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                                                <li><a class="dropdown-item" href="{{route('penerbit.edit', $row->id)}}">Edit</a></li>
                                                <li>
                                                    <form action="{{ route('penerbit.destroy', $row->id) }}"
